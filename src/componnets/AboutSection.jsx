      ...
      {show && (
        ...
        >
          <div className="max-w-4xl text-center mt-20 mb-20">
            ...
            <button
              onClick={onClose}
              className="absolute top-10 left-1/2 -translate-x-1/2 bg-gray-700/30 p-3 rounded-full shadow-lg backdrop-blur-sm hover:scale-110 transition-transform duration-300 cursor-pointer"
            >
            ...
            <div className="relative mx-auto w-36 h-36 md:w-44 md:h-44 mb-6">
              <img
                ...
                alt="Issac"
                className="w-full h-full rounded-full object-cover border-2 border-blue-600 shadow-md shadow-blue-100/20 dark:shadow-blue-900/30"
              />
            ...
            >
              {[
                ...
                <span
                  key={skill}
                  className="px-4 py-2 bg-blue-800/40 text-blue-200 rounded-full text-sm font-medium shadow-sm"
                >
                  {skill}
                </span>
              ))}
