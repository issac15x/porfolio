    ...
    <AnimatePresence>
      {show && (
        <motion.section
          ...
          className="fixed inset-0 z-50 flex justify-center items-start overflow-y-auto bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 px-4 sm:px-8 pt-24 pb-32 backdrop-blur-md"
        >
          <div className="w-full max-w-6xl text-center">
            {/* Close button */}
            <button
              onClick={onClose}
              className="fixed top-6 left-1/2 -translate-x-1/2 bg-gray-700/30 p-3 rounded-full shadow-md backdrop-blur-sm hover:scale-110 transition"
            >
              <ChevronsDown size={28} className="text-blue-300" />
            </button>
            ...
            >
              {current.projects.map((project, index) => (
                <motion.div
                  ...
                  className="bg-gray-800 p-5 sm:p-6 rounded-2xl shadow-lg transition-transform duration-300"
                >
